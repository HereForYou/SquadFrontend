            ...
            <div className="">
                ...
                <div className="joinModal drop-shadow-lg">
                    ...
                    <div className="p-5  rounded-lg">
                        <h1 className="text-center mt-2 text-chocolate-main text-lg ">CREATE A NEW GROUP</h1>
                        ...
                        <textarea placeholder="Write a description..." className="mt-2 outline-none border-2 border-black w-4/5 p-[10px] rounded-xl text-chocolate-main" rows={4} />
                        <h2 className="text-left text-lg text-chocolate-main mt-2">
                            ADD MEMBERS
                        </h2>
                        ...
                        <div className="flex flex-wrap gap-3">
                            ...
                            <div className="items-center rounded-full object-cover w-[60px] h-[60px] text-lg text-center justify-center flex bg-gray-200" onClick={() => setAddMemberModalState(true)} >
                                +
                            </div>
                        ...
                        <div className="flex p-[1px] border rounded-[30px] border-black  h-[30px] mt-2 w-1/2">
                            <input className="w-full h-full bg-transparent  border border-none outline-none outline-[0px] px-[10px] text-chocolate-main" type="text" placeholder=" XXXXX " />
                        </div>
